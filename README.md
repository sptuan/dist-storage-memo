...
2026 年，随着大模型 agentic 应用的爆发，模型的推理和训练愈发具备价值。本书也逐渐补充大模型推理与训练中的高性能存储系统研究，包括模型训练的 CheckPoint 高性能存储、模型推理 KV Cache 存储和传输等问题。
...
| [5.1 复制策略设计](https://memo.steinslab.io/storage-engine/replicate/) | 复制组, 编码 | ⭐️⭐️⭐️⭐️ |
| [5.2 分区策略设计](https://memo.steinslab.io/storage-engine/partition/) | 分区, 路由, 负载均衡 | ⭐️⭐️⭐️⭐️ |
...
| [6.1 Raft 共识 101](https://memo.steinslab.io/raft/raft_101/) | Raft, 共识, Leader 选举, 日志复制 | 编辑中 |
